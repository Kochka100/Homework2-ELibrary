...
$.extend($.validator, {
	...
	addClassRules: function(className, rules) {
		/// <summary>
		/// Retrieve a compound class method - useful to refactor common combinations of rules into a single
		/// class.
		/// </summary>
	...
	addMethod: function(name, method, message) {
		/// <summary>
		/// Retrieve a custom validation method. It must consist of a name (must be a legal javascript 
