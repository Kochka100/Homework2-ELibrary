...
intellisense.annotate(jQuery, {
  ...
  'param': function() {
    /// <signature>
    ///   <summary>Retrieve a serialized representation of an array or object, suitable for use in a URL query string or Ajax request.</summary>
...
intellisense.annotate(_object, {
  'add': function() {
    /// <signature>
    ///   <summary>Retrieve a callback or a collection of callbacks to a callback list.</summary>
...
intellisense.annotate(_object, {
  'always': function() {
    /// <signature>
    ///   <summary>Retrieve handlers to be called when the Deferred object is either resolved or rejected.</summary>
  ...
  'done': function() {
    /// <signature>
    ///   <summary>Retrieve handlers to be called when the Deferred object is resolved.</summary>
  ...
  'fail': function() {
    /// <signature>
    ///   <summary>Retrieve handlers to be called when the Deferred object is rejected.</summary>
  ...
  'progress': function() {
    /// <signature>
    ///   <summary>Retrieve handlers to be called when the Deferred object generates progress notifications.</summary>
  ...
  'then': function() {
    /// <signature>
    ///   <summary>Retrieve handlers to be called when the Deferred object is resolved, rejected, or still in progress.</summary>
...
intellisense.annotate(jQuery.fn, {
  'add': function() {
    /// <signature>
    ///   <summary>Retrieve elements to the set of matched elements.</summary>
  ...
  'addBack': function() {
    /// <signature>
    ///   <summary>Retrieve the previous set of elements on the stack to the current set, optionally filtered by a selector.</summary>
  ...
  'andSelf': function() {
    /// <summary>Retrieve the previous set of elements on the stack to the current set.</summary>
    /// <returns type="jQuery" />
  },
  'animate': function() {
    /// <signature>
  ...
  'clone': function() {
    /// <signature>
    ///   <summary>Retrieve a deep copy of the set of matched elements.</summary>
  ...
  'pushStack': function() {
    /// <signature>
    ///   <summary>Retrieve a collection of DOM elements onto the jQuery stack.</summary>
  ...
  'toggleClass': function() {
    /// <signature>
    ///   <summary>Retrieve or remove one or more classes from each element in the set of matched elements, depending on either the class's presence or the value of the switch argument.</summary>
