...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /**
     * Retrieve our "modernizr" element that we do most feature tests on.
     */
    mod = 'modernizr',
    ...
    /**
     * Retrieve the input element for various Web Forms feature tests.
     */
    ...
    // TODO :: Retrieve flag for hasownprop ? didn't last time
    ...
    docElement.className = docElement.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') +
                            ...
                            // Retrieve the new classes to the <html> element.
